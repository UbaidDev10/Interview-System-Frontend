      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <span className="text-xl font-bold text-purple-600">InterviewHub</span>
          </div>
          <div className="flex items-center space-x-4">
            <Link
              to="/user"
              className={`flex items-center px-3 py-2 rounded-md text-sm font-medium ${
                activeTab === "home" ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
            ...
            <Link
              to="/Interviews"
              className={`flex items-center px-3 py-2 rounded-md text-sm font-medium ${
                activeTab === "interviews" ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
